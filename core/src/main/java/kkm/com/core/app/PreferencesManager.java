...
public class PreferencesManager {
    ...
    private static final String SPO_ID = "spo_id";
    private static final String SPO_USERNAME = "spo_username";
    private static final String SPO_PASSWORD = "spo_password";
    private static final String M2PStatus = "M2PStatus";
...
//    saved login
    public String getM2PStatus() {
        return mPref.getString(M2PStatus, "0");
    }

    public void setM2PStatus(String value) {
        mPref.edit().putString(M2PStatus, value).apply();
    }
    ...
    public String getSPOID() {
        return mPref.getString(SPO_ID, "");
    }

    public void setSPOID(String value) {
        mPref.edit().putString(SPO_ID, value).apply();
    }


    //    SPO USERNAME
    public String getSPO_USERNAME() {
        return mPref.getString(SPO_USERNAME, "");
    }

    public void setSPO_USERNAME(String value) {
        mPref.edit().putString(SPO_USERNAME, value).apply();
    }


    //    SPO PASSWORD
    public String getSPO_PASSWORD() {
        return mPref.getString(SPO_PASSWORD, "");
    }

    public void setSPO_PASSWORD(String value) {
        mPref.edit().putString(SPO_PASSWORD, value).apply();
    }
