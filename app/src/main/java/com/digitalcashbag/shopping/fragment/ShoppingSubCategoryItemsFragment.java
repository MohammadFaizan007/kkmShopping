...
import com.digitalcashbag.shopping.adapter.ShoppingSubCategoryItemsFragmentAdapter;
...
public class ShoppingSubCategoryItemsFragment extends BaseFragment implements MvpView {
    Unbinder unbinder;
    @BindView(R.id.gv)
    RecyclerView gv;
    String category_id, title_st;
    private List<ChildCategoryItem> itemList;
        ...
        responseCategoryCall.enqueue(new Callback<ResponseMainCategory>() {
            ...
            public void onResponse(@NonNull Call<ResponseMainCategory> call, @NonNull Response<ResponseMainCategory> response) {
                ...
                if (response.body() != null && response.body().getResponse().equalsIgnoreCase("Success")
                    ...
                    itemList = response.body().getCategoryData().get(0).getChildCategory();
                    ShoppingSubCategoryItemsFragmentAdapter shoppingFragmentAdapter =
                            new ShoppingSubCategoryItemsFragmentAdapter(context, itemList, ShoppingSubCategoryItemsFragment.this);
